package de.emdete.tabulae.traffic;
...
import static de.emdete.tabulae.traffic.Constants.*;
	...
	public static Incidents go_ndr(File cache_dir, Incidents incidents) throws Exception {
		...
		if ("FeatureCollection".equals(type)) {
			for (Object o: (List)base.get("features")) {
				...
				if (("traffic_jam".equals(category_id) || "construction_area".equals(category_id))
				&& ("aroad".equals(street_type) || "m1road".equals(street_type))) {
				//if (position.size() > 1) {
