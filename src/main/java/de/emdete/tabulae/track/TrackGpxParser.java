	...
	class Handler extends DefaultHandler {
		...
		public void startElement(String uri, String localName, String name, Attributes attributes) throws SAXException {
			...
			if (localName.equalsIgnoreCase(TRKPT)) {
				if (trackPointItem != null) Log.e(de.emdete.tabulae.Constants.TAG, "trkpt in trkpt");
				...
				if (Constants.DEBUG)
					Log.d(Constants.TAG, "start gpx version=" + attributes.getValue("version") + ", creator=" + attributes.getValue("creator"));
				trackItem = new TrackItem();
			} else if (localName.equalsIgnoreCase("rte")) {
				if (Constants.DEBUG) Log.d(Constants.TAG, "This is probably a route file");
			} else if (localName.equalsIgnoreCase(WPT)) {
				if (Constants.DEBUG) Log.d(Constants.TAG, "This is probably a way point file");
			}
