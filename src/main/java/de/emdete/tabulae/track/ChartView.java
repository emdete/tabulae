...
public class ChartView extends View {
	...
	public ChartView(Context context, AttributeSet attrs) {
		...
		borderPaint.setColor(res.getColor(R.color.black, null));
		...
		//noinspection deprecation
		graphPaint[0].setColor(res.getColor(R.color.blue, null));
		...
		//noinspection deprecation
		graphPaint[0].setShadowLayer(10.0f, 0, 0, res.getColor(R.color.blue, null));
		graphPaint[1] = new Paint(graphPaint[0]);
		//noinspection deprecation
		graphPaint[1].setColor(res.getColor(R.color.green, null));
		//noinspection deprecation
		graphPaint[1].setShadowLayer(10.0f, 0, 0, res.getColor(R.color.green, null));
