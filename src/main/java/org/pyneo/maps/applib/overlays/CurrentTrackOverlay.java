package org.pyneo.maps.applib.overlays;
...
import org.pyneo.maps.applib.MainActivity;
import org.pyneo.maps.applib.kml.PoiManager;
import org.pyneo.maps.applib.kml.Track;
import org.pyneo.maps.applib.trackwriter.IRemoteService;
import org.pyneo.maps.applib.trackwriter.ITrackWriterCallback;
...
public class CurrentTrackOverlay extends TileViewOverlay {
	...
	private org.pyneo.maps.applib.view.TileView.OpenStreetMapViewProjection mBasePj;
	...
	protected void onDraw(Canvas c, TileView osmv) {
		...
		final org.pyneo.maps.applib.view.TileView.OpenStreetMapViewProjection pj = osmv.getProjection();
	...
	private class TrackThread extends Thread {
		...
		public void run() {
			...
			if (folder.canRead()) {
				...
				try {
					db = new org.pyneo.maps.applib.trackwriter.DatabaseHelper(mContext, folder.getAbsolutePath() + "/writedtrack.db").getReadableDatabase();
				}
				catch (Exception e) {
					db = null;
				}
