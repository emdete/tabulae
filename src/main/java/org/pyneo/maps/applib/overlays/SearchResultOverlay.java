...
import org.pyneo.maps.applib.utils.CoordFormatter;
import org.pyneo.maps.applib.utils.DistanceFormatter;
...
public class SearchResultOverlay extends TileViewOverlay {
	...
	public boolean onSingleTapUp(MotionEvent e, TileView mapView) {
		if (mLocation != null) {
			final org.pyneo.maps.applib.view.TileView.OpenStreetMapViewProjection pj = mapView.getProjection();
			final Point screenCoords = new Point();
