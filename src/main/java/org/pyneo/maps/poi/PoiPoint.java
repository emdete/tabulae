...
public class PoiPoint implements Constants {
	...
	public PoiPoint(int id, String mTitle, String mDescr, GeoPoint mGeoPoint, int iconid, int categoryid, double alt, int hidden) {
		this.mId = id;
		this.mTitle = mTitle;
		this.mDescr = mDescr;
